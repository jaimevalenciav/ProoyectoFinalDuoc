...
@NonNullApi
public class FleetManagerMobileProjectDependency extends DelegatingProjectDependency {

    @Inject
    public FleetManagerMobileProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
