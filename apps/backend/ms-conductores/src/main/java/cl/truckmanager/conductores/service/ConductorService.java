...
public class ConductorService {
    ...
    /** Uso externo: valida que el conductor pertenezca a la empresa del JWT */
    public Conductor obtenerPorId(String id, String empresaId) {
    ...
    public Conductor actualizar(String id, String empresaId, ConductorDto datos) {
